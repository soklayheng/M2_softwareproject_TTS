...
HIFIGAN_CONFIG = './Grad-TTS/checkpts/hifigan-config.json'
HIFIGAN_CHECKPT = './Grad-TTS/checkpts/hifigan.pt'


if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('-f', '--file', type=str, required=False, help='path to a file with texts to synthesize')
    parser.add_argument('-c', '--checkpoint', type=str, required=False, default='./Grad-TTS/checkpts/grad-tts-old.pt',help='path to a checkpoint of Grad-TTS')
